...
public class KingTest {
	...
	/*
	 * Tests whether the King constructor works
	 */
	
	@Test
	public void testKingConstructor() {
		Coordinate coord = new Coordinate("h8",7,7);
		King p = new King(Color.WHITE,coord,"K");
	...
	/*
	 * Tests whether the vertical movement of the King works
	 */

	@Test
	public void testKingVericalMovement(){
		makeBoard(8,8);
		
		King a1 = new King(Color.WHITE,coords[7][0],"K");
		coords[7][0].setPiece(a1);
		
		
		Piece p = coords[7][0].getCurrentPiece();
		
		Coordinate destination = coords[6][0];
	...
	/*
	 * Tests whether the horizontal movement of the King works
	 */
	
	@Test
	public void testKingHorizontalMovement(){
		makeBoard(8,8);
		...
		Coordinate destination = coords[7][1];
		boolean move = p.canMove(destination, coords);
		assertEquals(move,true);
