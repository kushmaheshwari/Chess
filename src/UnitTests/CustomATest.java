...
public class CustomATest {
	
	private static Coordinate[][] coords = null;
	
	@Test
	public void testCustomAConstructor() {
		Coordinate coord = new Coordinate("h8",7,7);
		CustomA p = new CustomA(Color.WHITE,coord,"B");
	...
	@Test
	public void testCustomAMovement(){
		makeBoard(8,8);
		
		CustomA a1 = new CustomA(Color.WHITE,coords[7][2],"R");
		coords[7][2].setPiece(a1);
		
		
		Piece p = coords[7][2].getCurrentPiece();
		
		Coordinate destination = coords[6][3];
	...
	@Test
	public void testCustomAInvalidMovement(){
		makeBoard(8,8);
		
		CustomA a1 = new CustomA(Color.WHITE,coords[6][2],"R");
		coords[6][2].setPiece(a1);
		
		
		Piece p = coords[6][2].getCurrentPiece();
		
		Coordinate destination = coords[7][3];
		boolean move = p.canMove(destination, coords);
