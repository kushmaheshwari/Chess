...
public class CustomBTest {
	
	private static Coordinate[][] coords = null;
	

	@Test
	public void testCustomBConstructor() {
		Coordinate coord = new Coordinate("h8",7,7);
		CustomB p = new CustomB(Color.WHITE,coord,"B");
	...
	@Test
	public void testCustomBMovement(){
		makeBoard(8,8);
		
		CustomB a1 = new CustomB(Color.WHITE,coords[7][2],"R");
		coords[7][2].setPiece(a1);
		
		
		Piece p = coords[7][2].getCurrentPiece();
		
		Coordinate destination = coords[6][2];
	...
	@Test
	public void testCustomBInvalidMovement(){
		makeBoard(8,8);
